<?php require APPROOT . '/views/inc/header.php' ?>
    ...
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed">
        ...
        <?php require APPROOT . '/views/inc/bodyheader.php' ?>

        <!-- Main Container -->
        <main id="main-container">

            <!-- Hero -->
            <div class="bg-image overflow-hidden" style="background-image: url('<?= URLROOT ?>/media/photos/photo3@2x.jpg');">
                                ...
                                <table class="table table-striped table-hover table-borderless table-vcenter font-size-sm mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell text-center">
                                            <img class="img-avatar img-avatar32" src="<?= URLROOT ?>/media/avatars/avatar15.jpg" alt="">
                                        </td>
                                        <td class="font-w600">
                                            Thomas Riley                                </td>
                                        <td class="d-none d-sm-table-cell text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell text-center">
                                            <img class="img-avatar img-avatar32" src="<?= URLROOT ?>/media/avatars/avatar2.jpg" alt="">
                                        </td>
                                        <td class="font-w600">
                                            Melissa Rice                                </td>
                                        <td class="d-none d-sm-table-cell text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell text-center">
                                            <img class="img-avatar img-avatar32" src="<?= URLROOT ?>/media/avatars/avatar3.jpg" alt="">
                                        </td>
                                        <td class="font-w600">
                                            Megan Fuller                                </td>
                                        <td class="d-none d-sm-table-cell text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell text-center">
                                            <img class="img-avatar img-avatar32" src="<?= URLROOT ?>/media/avatars/avatar12.jpg" alt="">
                                        </td>
                                        <td class="font-w600">
                                            Albert Ray                                </td>
                                        <td class="d-none d-sm-table-cell text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell text-center">
                                            <img class="img-avatar img-avatar32" src="<?= URLROOT ?>/media/avatars/avatar1.jpg" alt="">
                                        </td>
                                        <td class="font-w600">
                                            Betty Kelley                                </td>
                                        <td class="d-none d-sm-table-cell text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell text-center">
                                            <img class="img-avatar img-avatar32" src="<?= URLROOT ?>/media/avatars/avatar11.jpg" alt="">
                                        </td>
                                        <td class="font-w600">
                                            Jose Wagner                                </td>
                                        <td class="d-none d-sm-table-cell text-center">
        ...
        <?php require APPROOT . '/views/inc/bodyfooter.php' ?>
